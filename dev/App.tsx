...
import { Menu, FloatingMenu } from 'molde-ui';
import type { MenuItemType, FloatingMenuItemType } from 'molde-ui';

const themes = ['cupcake', 'forest', 'synthwave', 'cyberpunk', 'retro', 'valentine'] as const;

function App() {
  const [activePath, setActivePath] = useState('/home');
  const [floatingMenuActivePath, setFloatingMenuActivePath] = useState('/home');
  ...
  const floatingMenuItems: FloatingMenuItemType[] = [
    {
      label: 'Home',
      path: '/home',
      icon: (
  ...
  const handleFloatingMenuClick = (path: string, item: FloatingMenuItemType) => {
    console.log('FloatingMenu item clicked:', { path, item });
    setFloatingMenuActivePath(path);
  };
    ...
    <div className="min-h-screen bg-base-200" data-theme={theme}>
      <div className="container mx-auto p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              ...
              <div className="form-control w-full mt-4">
                <label className="label">
                  <span className="label-text">Floating Menu Position</span>
                </label>
                <select
                  className="select select-bordered w-full"
                  value={floatingMenuPosition}
                  onChange={e =>
                ...
                >
                  ...
                  <optgroup label="Left Side">
                    ...
                    <option value="leftStart">Left Start (Top)</option>
                    <option value="leftEnd">Left End (Bottom)</option>
                  </optgroup>
                  <optgroup label="Right Side">
                    <option value="right">Right (Center)</option>
                    <option value="rightStart">Right Start (Top)</option>
                    <option value="rightEnd">Right End (Bottom)</option>
                  </optgroup>
                </select>
              </div>
        ...
        <div className="mt-8">
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              <h2 className="card-title">FloatingMenu Component</h2>
              <p className="text-sm text-base-content/70 mb-4">
                Menu flutuante fixo com toast no hover. Mostrando posição:{' '}
                <strong>{floatingMenuPosition}</strong>
              </p>
              <div className="mt-4 p-4 bg-base-200 rounded-lg min-h-[400px] relative">
                <p className="text-sm mb-4">
                  <strong>Active Path:</strong>{' '}
                  <code className="bg-base-300 px-2 py-1 rounded">{floatingMenuActivePath}</code>
                </p>
                <FloatingMenu
                  items={floatingMenuItems}
                  activePath={floatingMenuActivePath}
                  onItemClick={handleFloatingMenuClick}
              ...
              <div className="mt-4">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-base-content/70">
                  <li>✅ Floating container with backdrop-blur</li>
                  <li>✅ Toast on hover for inactive items</li>
                  <li>✅ Label appears next to icon when active</li>
                  <li>✅ Smooth animations and transitions</li>
                  <li>✅ Multiple positions: bottomCenter, left, right</li>
                  <li>✅ Vertical layout for left/right positions</li>
                </ul>
              </div>
            </div>
          </div>
